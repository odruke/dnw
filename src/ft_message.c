...
char	*ft_message(char *ide, int lang)
{
	...
	Lang_msgs	en[] = {
		...
		{"misplaced", "letter %c is somewere else\n"},
	...
	Lang_msgs	sp[] = {
		...
		{"misplaced","La letra %c esta en otro sitio\n"},
	...
	//french
	Lang_msgs	fr[] = {
		{"welcome", "***********  D  N  W  ***********\n\nBienvenue au Definetely Not Wordle!\n\n\nSvp, tapez une mot de cinq lettres pour commencer le jeux\n\n"},
		{"tries", "\n\nIl vous reste %i tentatives, veuillez réessayer\n"},
		{"misplaced","La lettre %c est à un autre endroit\n"},
